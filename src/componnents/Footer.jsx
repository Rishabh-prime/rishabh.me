  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/Rishabh-prime",
    ...
    },
    {
      ...
      url: "https://www.linkedin.com/in/rishabh--thakur/",
    ...
    },
    {
      ...
      url: "https://www.instagram.com/rish_thakur__/#",
      color:
    ...
    },
    {
      ...
      url: "https://leetcode.com/u/rish_thakur__/",
    ...
    },
    {
      ...
      url: "https://codepen.io/eqvdapkl-the-selector",
  ...
  return (
    <footer className="relative overflow-hidden border-t border-gray-700 bg-gradient-to-b from-gray-900/50 to-black/80">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="text-center lg:text-left">
                ...
                <div className="grid grid-cols-1 gap-4 mb-6">
                  <div className="text-center p-4 border border-gray-600 rounded-xl hover:border-white transition-all duration-300 hover:shadow-lg hover:bg-gray-800/30">
            ...
            <div className="lg:col-span-1">
              <div className="text-center">
                ...
                <div className="flex flex-col gap-4 justify-center mt-6 max-w-xs mx-auto">
                  <button
                    onClick={() =>
                      window.open(
        ...
        {/* Bottom Section */}
        <div className="border-t border-gray-700 py-8 md:py-10">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            {/* Copyright */}
            <div className="text-center sm:text-left">
              <p className="text-gray-400 text-sm md:text-base flex items-center justify-center sm:justify-start gap-2">
                Made with <span className="text-red-500 animate-pulse text-lg">❤</span>{" "}
                in the cosmos
              </p>
