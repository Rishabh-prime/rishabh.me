...
function Projects() {
  ...
  {projects.map((project) => (
    ...
    >
      <div className="bg-opacity-20 border border-gray-700 rounded-xl p-6 transition-all duration-300 hover:border-purple-500 hover:shadow-lg hover:shadow-purple-500/20 hover:bg-black/80 hover:backdrop-blur-sm cursor-pointer h-full">
        <div className="mb-6">
